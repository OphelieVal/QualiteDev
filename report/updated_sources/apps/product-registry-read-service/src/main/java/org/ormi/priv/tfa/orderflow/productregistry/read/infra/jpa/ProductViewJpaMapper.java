...
/**
 * Mappeur MapStruct pour convertir entre l'entité JPA `ProductViewEntity`
 * et le modèle de domaine `ProductView`.
 *
 * Fournit des méthodes de conversion et des helpers pour (dé)sérialiser
 * les listes d'événements et de références de catalogues en JSON.
 */
