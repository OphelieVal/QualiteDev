...
/**
 * Mappeur MapStruct convertissant la `ProductView` du domaine en `ProductViewDto`
 * utilisée par l'API REST de lecture.
 *
 * Contient des mappers imbriqués pour les événements, leurs payloads et les catalogues.
 */
