...
/**
 * Client REST vers l'API de domaine `product-registry` pour opérations de commande.
 *
 * Fournit les appels distants pour enregistrer, retirer et mettre à jour un produit.
 */
