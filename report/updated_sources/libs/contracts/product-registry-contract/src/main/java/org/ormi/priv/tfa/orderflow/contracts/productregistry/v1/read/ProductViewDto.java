...
/**
 * DTO exposé via l'API pour représenter la vue en lecture d'un produit.
 *
 * Sert au transport JSON des données de produit (métadonnées, catalogues, événements, horodatages).
 */
