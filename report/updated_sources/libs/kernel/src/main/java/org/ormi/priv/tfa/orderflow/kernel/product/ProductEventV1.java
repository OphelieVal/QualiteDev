...
/**
 * Interface scellée représentant les événements de produit (version 1).
 *
 * Contient les définitions des événements supportés (enregistrement, retrait,
 * mise à jour du nom et de la description) et leur payload associé.
 */
