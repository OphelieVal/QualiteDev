...
/**
 * Modèle de lecture représentant l'état courant d'un produit.
 *
 * Contient les informations nécessaires pour les consultations : identifiant,
 * SKU, nom, description, statut, catalogues associés, événements et horodatages.
 */
