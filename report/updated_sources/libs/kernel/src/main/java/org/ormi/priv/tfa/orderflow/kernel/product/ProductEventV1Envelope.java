...
/**
 * Enveloppe standardisée pour les événements produit (version 1).
 *
 * Fournit des sous-classes typées pour chaque événement afin de simplifier
 * le traitement et la persistance côté infrastructure.
 */
