...
/**
 * Agrégat métier représentant un produit et ses opérations.
 *
 * Expose les comportements de création, mise à jour (nom/description)
 * et retrait, en produisant des enveloppes d'événements pour la persistance
 * et la diffusion.
 */
