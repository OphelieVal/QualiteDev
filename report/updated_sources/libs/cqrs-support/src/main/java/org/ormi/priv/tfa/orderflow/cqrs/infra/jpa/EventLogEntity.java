...
/**
 * Entité JPA représentant une entrée du journal d'événements (event log).
 *
 * Stocke le type d'agrégat, l'identifiant, la version, le type/version d'événement,
 * l'horodatage et le payload JSON.
 */
