...
/**
 * Mappeur MapStruct pour convertir une `EventEnvelope` en `EventLogEntity`.
 *
 * Sérialise le payload en JSON et renseigne les métadonnées d'événement (type/version).
 */
