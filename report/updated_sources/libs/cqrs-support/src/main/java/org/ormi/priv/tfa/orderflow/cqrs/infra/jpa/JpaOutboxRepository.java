...
/**
 * Implémentation JPA du repository d'outbox.
 *
 * Charge une requête native pour récupérer les messages prêts à être envoyés
 * et gère le marquage des échecs / retards.
 */
