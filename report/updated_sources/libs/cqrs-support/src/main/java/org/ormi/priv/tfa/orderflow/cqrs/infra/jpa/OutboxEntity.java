...
/**
 * Entité JPA représentant une entrée d'outbox utilisée pour la livraison d'événements.
 *
 * Contient des métadonnées de tentative et un lien vers l'événement source (EventLogEntity).
 */
